...
mm.on("collect", r => {
 ...
 .setTitle(`Welcome To ${msg.guild.name}`)
           .setFooter(`- Requested By: ${msg.author.tag}`,msg.author.avatarURL)
  .setURL('https://discordapp.com/api/oauth2/authorize?client_id=468062572458016788&permissions=8&scope=bot')
.setDescription(`** :wrench: Admins Commends** \n${prefix}**mute - لعمل ميوت للعضو**\n${prefix}**unmute لفك الميوت عن  العضو**\n${prefix}**bc - الرساله الجماعيه**\n${prefix}**ban - أمر الباند**\n${prefix}**kick - أمر الكيك**\n${prefix}**cc [number] - لصنع رتب الوان باختيار عدد**\n${prefix}**dc - لحذف جميع رتب الالوان فقط**\n${prefix}clear - لمسح الشات**\n${prefix}role [mention] [rolename] - لاعطاء شخص رتبة**\n${prefix}rerole [user] [rolename] - لازالة رتبة من شخص**\n${prefix}move [user] - لنقل شخص من روم صوتي لرومك**\n${prefix}move all - لنقل جميع المتواجدين بـ الرومات لرومك**\n${prefix}mct - لقفل جميع الرومات الكتابية**\n${prefix}umct - لفتح جميع الرومات الكتابية**\n${prefix}mcv - لقفل جميع الرومات الصوتية**\n${prefix}umcv - لفتح جميع الرومات الصوتية**`)
